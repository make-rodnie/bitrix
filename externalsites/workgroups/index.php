...
?><?$APPLICATION->IncludeComponent("bitrix:socialnetwork_group", "", array(
	...
	"NAME_TEMPLATE" => "",
	"PATH_TO_USER" => "/externalsites/contacts/personal/user/#user_id#/",
	"PATH_TO_USER_LOG" => "/externalsites/contacts/personal/log/",
	"PATH_TO_SUBSCRIBE" => "/externalsites/contacts/personal/subscribe/",
	"PATH_TO_GROUP_CREATE" =>"/externalsites/contacts/personal/user/#user_id#/groups/create/",
	"PATH_TO_SEARCH_EXTERNAL" => "/externalsites/contacts/index.php",
	"PATH_TO_MESSAGES_CHAT" => "/externalsites/contacts/personal/messages/chat/#user_id#/",
	"PATH_TO_USER_CALENDAR" => "/externalsites/contacts/personal/user/#user_id#/calendar/",
	"PATH_TO_MESSAGE_FORM_MESS" => "/externalsites/contacts/personal/messages/form/#user_id#/#message_id#/",
	"PATH_TO_CONPANY_DEPARTMENT" => "/company/structure.php?set_filter_structure=Y&structure_UF_DEPARTMENT=#ID#",
	"PATH_TO_VIDEO_CALL" => "/externalsites/contacts/personal/video/#USER_ID#/",
	"PATH_TO_BIZPROC_TASK" => "/externalsites/contacts/personal/user/#user_id#/bizproc/#id#/",
	"PATH_TO_BIZPROC_TASK_LIST" => "/externalsites/contacts/personal/user/#user_id#/bizproc/",
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "/externalsites/workgroups/",
	"AJAX_MODE" => "N",
