...
if ($GLOBALS["USER"]->IsAuthorized()):
	if (
		...
		$aMenuB24[] = Array(
			...
			"/externalsites/contacts/personal/user/".$USER_ID."/tasks/",
			Array(),
...
/*
	if (
		...
		$aMenuB24[] = Array(
			...
			"/externalsites/contacts/personal/user/".$USER_ID."/calendar/",
			Array(),
			Array(),
...
*/
	if (
		...
		$aMenuB24[] = Array(
			...
			"/externalsites/contacts/personal/user/".$USER_ID. ($diskEnabled? "/disk/path/" : "/files/lib/"),
			Array(),
			Array(),
	...
	if (
		...
		$aMenuB24[] = Array(
			...
			"/externalsites/contacts/personal/user/".$USER_ID."/photo/",
			Array(),
			Array(),
	...
	if (
		...
		$aMenuB24[] = Array(
			...
			"/externalsites/contacts/personal/user/".$USER_ID."/blog/",
			Array(),
