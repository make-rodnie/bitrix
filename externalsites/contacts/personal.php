...
?> <?$APPLICATION->IncludeComponent("bitrix:socialnetwork_user", ".default", array(
	...
	"NAME_TEMPLATE" => "",
	"PATH_TO_GROUP" => "/externalsites/workgroups/group/#group_id#/",
	"PATH_TO_GROUP_SUBSCRIBE" => "/externalsites/workgroups/group/#group_id#/subscribe/",
	"PATH_TO_GROUP_SEARCH" => "/externalsites/workgroups/group/search/",
	"PATH_TO_SEARCH_EXTERNAL" => "/externalsites/contacts/",
	"PATH_TO_CONPANY_DEPARTMENT" => "/company/structure.php?set_filter_structure=Y&structure_UF_DEPARTMENT=#ID#",
	"PATH_TO_GROUP_TASKS" => "/externalsites/workgroups/group/#group_id#/tasks/",
	"PATH_TO_GROUP_TASKS_TASK" => "/externalsites/workgroups/group/#group_id#/tasks/task/#action#/#task_id#/",
	"PATH_TO_GROUP_TASKS_VIEW" => "/externalsites/workgroups/group/#group_id#/tasks/view/#action#/#view_id#/",
	"PATH_TO_GROUP_POST" => "/externalsites/workgroups/group/#group_id#/blog/#post_id#/",
	"PATH_TO_CONPANY_DEPARTMENT" => "/company/structure.php?set_filter_structure=Y&structure_UF_DEPARTMENT=#ID#",
	"PATH_TO_VIDEO_CALL" => "/externalsites/contacts/personal/video/#USER_ID#/",
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "/externalsites/contacts/personal/",
	"AJAX_MODE" => "N",
...
//		"group_create" => "/externalsites/workgroups/create/",
