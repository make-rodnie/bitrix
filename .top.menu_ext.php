		...
		$arMenuB24[] = array(
			...
			array(
				"real_link" => getLeftMenuItemLink(
					...
					CBXFeatures::IsFeatureEnabled('Calendar') ? SITE_DIR."company/personal/user/".$userId."/calendar/" : SITE_DIR."calendar/"
				),
...
{
/* want to hide chat and calls in menu -----	
$arMenuB24[] = array(
...
if (CModule::IncludeModule("socialnetwork"))
{
	...
	$arMenuB24[] = array(
		...
		) + ($canCreateGroup ? array("sub_link" => SITE_DIR."workgroups/?new") : array()),
