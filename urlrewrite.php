...
$arUrlRewrite = array(
	...
	array(
		"CONDITION" => "#^/externalsites/contacts/personal/#",
		"RULE" => "",
		"ID" => "bitrix:socialnetwork_user",
		"PATH" => "/externalsites/contacts/personal.php",
	),
	array(
		"CONDITION" => "#^/externalsites/workgroups/create/#",
		"RULE" => "",
		"ID" => "bitrix:extranet.group_create",
		"PATH" => "/externalsites/workgroups/create/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/externalsites/mobile/webdav#",
		"RULE" => "",
		"ID" => "bitrix:mobile.webdav.file.list",
		"PATH" => "/externalsites/mobile/webdav/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/externalsites/workgroups/#",
		"RULE" => "",
		"ID" => "bitrix:socialnetwork_group",
		"PATH" => "/externalsites/workgroups/index.php",
	),
	array(
