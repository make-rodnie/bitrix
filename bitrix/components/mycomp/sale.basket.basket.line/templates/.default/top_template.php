...
?>
<link href= <?php
echo "'" . SITE_TEMPLATE_PATH . "/template_styles.css'"; ?> rel="stylesheet" />
...
<?endif?>
	<div class="bx-basket-block"><?
		if (!$arResult["DISABLE_USE_BASKET"])
		{
			...
			<a href="/webshop/basket.php" class="mycart"><?= GetMessage('TSB1_CART') ?></a><?
		}
		if (!$compositeStub)
		{
			...
			<span>
				<?= '&nbsp&nbsp&nbsp&nbsp'.GetMessage('TSB1_TOTAL_PRICE') ?>
